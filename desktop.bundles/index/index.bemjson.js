    ...
    content: [
        {
            ...
            // {
            //     block : 'menu-main',
            //     links : [ 'Карта штата', 'Информация', 'Фото и видео', 'Гостиницы', 'Sedona']
            // }
                {
                    block: 'menu-main',
                    content: [
                        ...
                        },
                        {
                            ...
                            return {
                                elem : 'item',
                                elemMods : { active : idx === 0, order_4 : idx === 0, shadow : idx === 3, order_5 : idx === 3, logo : idx === 4, open: false },
                                content : {
                                    block : 'link',
